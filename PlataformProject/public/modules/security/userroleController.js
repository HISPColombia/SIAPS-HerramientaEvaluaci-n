appServersoft.controller('userroleController', ['$scope', '$filter', 'commonvariable', 'authentication','$localStorage','userrole', function ($scope, $filter, commonvariable, authentication, $localStorage, userrole) {
///verify session
