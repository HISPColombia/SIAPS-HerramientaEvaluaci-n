appServersoft.controller('projectController', ['$scope', '$filter', 'commonvariable', 'authentication','$localStorage','person','user','role', 'userrole',function ($scope, $filter, commonvariable, authentication, $localStorage, person, project, role, userrole) {
///verify session
