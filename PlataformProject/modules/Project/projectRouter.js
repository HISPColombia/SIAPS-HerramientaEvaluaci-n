...
router.get('/sys/systemproject/:proid', function (req, res) {
    ...
    var query="SELECT project.proid, project.prname,systemproject.sysoid, system.sysname, system.initials FROM public.system, public.systemproject, public.project WHERE system.sysoid = systemproject.sysoid AND project.proid = systemproject.proid AND project.proid = "+req.params.proid+" order by system.sysoid";
